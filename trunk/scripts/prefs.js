	...
	loadprefs: function(){
		...
		if (prefsfile.exists) {
			try {
				...
				try{
					var versionnumber = prefsXML.getElementsByTagName("versionNumber")[0].firstChild.nodeValue;
					$(this).log("versionnumber: " + versionnumber);
					if (versionnumber != "")//if empty use default
